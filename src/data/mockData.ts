...
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">Between June and July 2026, Equal Justice Initiative (Nigeria)  participated in a series of detention monitoring visits across police divisions and other detention facilities within the Federal Capital Territory (FCT) interviewing 50 detainees and observing approximately 100 migrants. </p>
<img src="/images/field-report/image4.jpg" alt="Report Image" class="my-12 rounded-xl shadow-lg w-full object-cover" />
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">This exercise was conducted alongside the Administration of Criminal Justice Monitoring Committee (ACJMC), Citizens' Gavel, the National Human Rights Commission (NHRC), the Nigerian Bar Association (NBA), Asabe Waziri Justice Advocacy Initiative (AWJAI), Legend Golden Care Foundation and FCT Magistrates, these visits formed part of ongoing efforts to promote accountability, safeguard the rights of persons in custody and strengthen compliance with the Administration of Criminal Justice Act (ACJA).</p>
...
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">During the month of July, the monitoring committee once again embarked on a follow-up visit to Bwari  and Ushafa Police Division on Wednesday, 8th August 2026. The exercise was led by Her Worship, Nonye Okonkwo, who identified a total of 17 detainees across both divisions.</p>
<img src="/images/field-report/image8.jpg" alt="Report Image" class="my-12 rounded-xl shadow-lg w-full object-cover" />
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">At Bwari Police Division, 6 detainees were interviewed. Of which, 3 are currently under investigation, 1 has been charged to court, 1 suspect was successfully released on bail, and 1 remains in custody pursuant to a remand order.</p>
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">The team then proceeded to Ushafa Police Division, where a total of 11 cases were reviewed. 4 suspects have been charged to court, 6 cases are currently under investigation and 1 suspect released on bail.</p>
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">Overall, both Bwari and Ushafa Police Divisions remain in fair condition, with officers providing full cooperation throughout the exercise. In total, 17 cases were reviewed by the EJI monitoring team under the leadership of Her Worship, Nonye Okonkwo.</p>
...
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">On Monday, 20 July 2026, at…time… the Equal Justice Initiative (EJI) conducted another monitoring exercise at Karu Police Division and Nyanya Police Division in collaboration with the Administration of Criminal Justice Monitoring Committee (ACJMC), Citizens' Gavel, the Nigerian Bar Association (NBA) Nyanya Branch, and Legend Golden Care Foundation. The exercise was led by Her Worship, Haruna A. Haruna.</p>
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">At Nyanya Police Division, 11 detainees were interviewed. Of these, five were released on bail, four were charged to court and two cases were reopened and are currently under investigation.</p>
<img src="/images/field-report/image3.jpg" alt="Report Image" class="my-12 rounded-xl shadow-lg w-full object-cover" />
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">At Karu Police Division, one detainee was interviewed, and the case remains under investigation.</p>
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">Overall, the team interviewed a total of 12 detainees during the monitoring exercise led by Her Worship, Haruna A. Haruna. While officers at both police divisions cooperated fully with the monitoring team, it was observed that the detention facilities at Nyanya Police Division require significant improvement, as they were found to be in poor condition. In contrast, the detention facilities at Karu Police Division were generally found to be in fair condition.</p>
...
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">On Thursday 23rd July the Equal Justice Initiative set out on a multi-agency monitoring visit  in collaboration with the Administration of Criminal Justice Monitoring Committee (ACJMC), Citizens' Gavel, the Asabe Waziri Justice Advocacy Initiative (AWJAI) and three FCT Magistrates, Her Worship Fatima Malo Nadoma, His Worship Muhammed Tahir, and His Worship Abdulmajid Oniyangi.</p>
...
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">Two persons were found in lawful custody pending investigation. The detention facility was observed to be clean, orderly and humane, with running water and adequate ventilation, reflecting good detention standards.</p>
...
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">The monitoring visit to Maitama Police Division was conducted in collaboration with the Administration of Criminal Justice Monitoring Committee (ACJMC), the Nigerian Bar Association (Karu Branch) and the Asabe Waziri Justice Advocacy Initiative (AWJAI), under the leadership of His Worship Abubakar Jega.</p>
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">The team interviewed two detainees, at the police division both of whom were found to be in lawful custody pending investigation.</p>
<p class="mb-6 md:mb-8 text-base md:text-lg leading-relaxed text-slate-700 indent-8">The station was observed to be clean, orderly and well maintained, with professional and cooperative officers who readily engaged with the monitoring team throughout the exercise reflecting positive institutional practices and demonstrated the importance of professionalism, transparency and compliance with due process within police detention facilities.</p>
